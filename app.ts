...
const quiz: {
    ...
    },
    {
        name: "question_2",
        type: "list",
        message: "Q2. Which of the folllowing characters is commmonly allowed in variables name in typescript",
        choices: ["$","@","#","&"]
    },
    {
        name: "question_3",
    ...
    },
    {
        name: "question_4",
        type: "list",
        message: "Q4. In Typescript, which symbol is commonly used to terminate a statemrnt",
        choices: ["." ,":" ,";" ,","]
    },
    {
        name: "question_5",
